  ...
  return (
    <section className='py-20'>
      <div className='text-center mb-10'>
          <h1 className='font-oswald text-5xl mb-4'><span className='text-slate-600'>Best</span> Sellers</h1>
      ...
      <div className='grid gird-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 place-content-center'>
        {result.data.products?.filter( element => element.isBestSeller == true).slice(0,5).map( (item, index)=>
